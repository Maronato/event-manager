                ...
                <tr v-bind:key="user.unique_id" v-for="user in paginatedUsers">
                    ...
                    <td>
                        ...
                        <sui-icon
                            size="large"
                            color="blue"
                            v-if="user.has_facebook"
                            name="facebook" />
                        <sui-icon
                            size="large"
                            color="black"
                            v-if="user.has_github"
                            name="github" />
                        <sui-icon
                            size="large"
                            color="red"
                    ...
                    <td class="right aligned collapsing">
                        <sui-button
                            ...
                            size="tiny"
                            content="Hacker"
                            v-bind:class="{blue: user.is_hacker, basic: !user.is_hacker }"
                            @click="$emit('toggle-ishacker', user.unique_id)" />

                        <sui-button
                            class="actionbuttons"
                            size="tiny"
                            content="Staff"
                            v-bind:class="{blue: user.is_staff, basic: !user.is_staff }"
                            @click="$emit('toggle-isstaff', user.unique_id)" />
                        <sui-button
                            class="actionbuttons"
                            size="tiny"
                            content="Admin"
                            v-bind:class="{blue: user.is_admin, basic: !user.is_admin }"
                            @click="$emit('toggle-isadmin', user.unique_id)" />
                        <br>
                        <sui-button
                            class="actionbuttons"
                            size="tiny"
                            content="Mentor"
                            v-bind:class="{blue: user.is_mentor, basic: !user.is_mentor }"
                            @click="$emit('toggle-ismentor', user.unique_id)" />
                        <sui-button
                            class="actionbuttons"
                            size="tiny"
                            color="red"
                            content="Apagar"
                            @click="$emit('delete-user', user.unique_id)" />
                    </td>
                </tr>
            </tbody>
