...
},{"_process":1,"timers":3}],5:[function(require,module,exports){
"use strict";
...
var _settings_subscriptions = require("project/js/settings_subscriptions");

var _settings_subscriptions2 = _interopRequireDefault(_settings_subscriptions);
...
var sub = new _vue2.default({
    ...
    data: function data() {
        return {
            ...
            sub: _settings_subscriptions2.default
        };
    },
    ...
    methods: {
        updateSettings: function updateSettings(data) {
            for (var key in data) {
                this.settings_context[key] = data[key];
            }
        }
    },
    mounted: function mounted() {
...
},{"project/js/settings_subscriptions":6,"vue":4}],6:[function(require,module,exports){
"use strict";
...
var settingssub = new _subscription.ModelSubscription("settings", "Settings", "update", false);
settingssub.connect();
...
exports.default = settingssub;

},{"model_sockets/js/subscription":7}],7:[function(require,module,exports){
"use strict";
...
},{"./ws_wrapper":8}],8:[function(require,module,exports){
"use strict";
