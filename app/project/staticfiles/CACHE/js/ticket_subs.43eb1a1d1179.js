...
},{"_process":2,"timers":4}],6:[function(require,module,exports){
"use strict";
...
var _notifications = require("project/js/notifications");

var _notifications2 = _interopRequireDefault(_notifications);

var _ticket_subscriptions = require("project/js/ticket_subscriptions");

var _ticket_subscriptions2 = _interopRequireDefault(_ticket_subscriptions);

function _interopRequireDefault(obj) {
    return obj && obj.__esModule ? obj : { default: obj };
}

var sub = new _vue2.default({
    el: "#ticketsub-app",
    data: function data() {
        return {
            sidebar: sidebar_context,
            user: user_context,
            subs: _ticket_subscriptions2.default,
            currentTicket: null,
            connected: false
        };
    },
    ...
    methods: {
        ...
        ticketUpdated: function ticketUpdated(ticket) {
            if (this.currentTicket.state == "open" && ticket.state == "claimed") {
                // Ticket was claimed
                (0, _notifications2.default)("Ticket pego", ticket.claimer.full_name + " pegou seu ticket!", "success");
            }
            if (this.currentTicket.state == "claimed" && ticket.state == "open") {
                // Ticket was claimed
                (0, _notifications2.default)("Ticket reaberto", this.currentTicket.claimer.full_name + " reabriu seu ticket", "info");
            }
            if (this.currentTicket.state == "claimed" && ticket.state == "unrated") {
                // Ticket was completed
                (0, _notifications2.default)("Ticket finalizado", "Não esqueça de avaliar " + ticket.claimer.full_name, "success");
            }
            this.currentTicket = ticket;
        },
        loadConnections: function loadConnections() {
            ...
            if (this.sidebar.active_tab != "helper" && (this.user.employee_company_access >= 0 || this.user.is_mentor)) {
...
},{"project/js/notifications":10,"project/js/ticket_subscriptions":11,"vue":5}],7:[function(require,module,exports){
"use strict";
...
var _subscription = require("model_sockets/js/subscription");
...
var TicketSubscription = function (_BaseSubscription) {
    _inherits(TicketSubscription, _BaseSubscription);

    function TicketSubscription(unique_id, signal, debug) {
        _classCallCheck(this, TicketSubscription);

        var _this = _possibleConstructorReturn(this, (TicketSubscription.__proto__ || Object.getPrototypeOf(TicketSubscription)).call(this, debug));

        _this.unique_id = unique_id;
        _this.signal = signal;
        _this.url = "/ws/subscriptions/tickets/" + unique_id + "/" + signal + "/";
        return _this;
    }

    return TicketSubscription;
}(_subscription.BaseSubscription);

exports.default = TicketSubscription;

},{"model_sockets/js/subscription":8}],8:[function(require,module,exports){
"use strict";
...
exports.GenericSubscription = exports.SelfSubscription = exports.ModelSubscription = exports.BaseSubscription = undefined;
...
var _ws_wrapper = require("./ws_wrapper");

var _ws_wrapper2 = _interopRequireDefault(_ws_wrapper);
...
var BaseSubscription = exports.BaseSubscription = function () {
    function BaseSubscription(debug) {
        _classCallCheck(this, BaseSubscription);

        this.listeners = [];
        this.debug = false;
        if (debug !== "undefined") this.debug = debug;
        this.url = "/ws/";
        this.webSocketBridge = new _ws_wrapper2.default();
        this.connected = false;
        this.allow_send = false;
    }

    _createClass(BaseSubscription, [{
        key: "connect",
        ...
        value: function subscribe(callback) {
            if (!this.connected) {
                console.error("Can't subscribe, websocket disconnected! Call .connect()");
                return;
            }
...
var ModelSubscription = exports.ModelSubscription = function (_BaseSubscription) {
    _inherits(ModelSubscription, _BaseSubscription);

    function ModelSubscription(app, model, signal, debug) {
        _classCallCheck(this, ModelSubscription);

        var _this = _possibleConstructorReturn(this, (ModelSubscription.__proto__ || Object.getPrototypeOf(ModelSubscription)).call(this, debug));

        _this.model = model;
        _this.signal = signal;
        _this.url = "/ws/subscriptions/models/" + app + "/" + model + "/" + signal + "/";
        return _this;
    }
...
var SelfSubscription = exports.SelfSubscription = function (_BaseSubscription2) {
    _inherits(SelfSubscription, _BaseSubscription2);

    function SelfSubscription(signal, debug) {
        _classCallCheck(this, SelfSubscription);

        var _this2 = _possibleConstructorReturn(this, (SelfSubscription.__proto__ || Object.getPrototypeOf(SelfSubscription)).call(this, debug));

        _this2.signal = signal;
        _this2.url = "/ws/subscriptions/instances/me/" + signal + "/";
        return _this2;
    }
...
var GenericSubscription = exports.GenericSubscription = function (_BaseSubscription3) {
    _inherits(GenericSubscription, _BaseSubscription3);

    function GenericSubscription(url, debug) {
        _classCallCheck(this, GenericSubscription);

        var _this3 = _possibleConstructorReturn(this, (GenericSubscription.__proto__ || Object.getPrototypeOf(GenericSubscription)).call(this, debug));

        _this3.url = url;
        _this3.allow_send = true;
        return _this3;
    }
...
},{"./ws_wrapper":9}],9:[function(require,module,exports){
"use strict";
...
},{"reconnecting-websocket":3}],10:[function(require,module,exports){
"use strict";
...
function desktopNotify(message) {
    var title = sidebar_context.event_name;
    var icon = sidebar_context.event_logo_png;
...
function toast(title, message, type) {
    ...
    var theme = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "light";
    var position = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : "topRight";

    if (document.hidden) {
        desktopNotify(message);
    }
    return _izitoast2.default[type]({
        title: title,
        message: message,
        type: type,
        timeout: timeout,
...
},{"izitoast":1}],11:[function(require,module,exports){
"use strict";
...
var _ticket_sub = require("helper/js/ticket_sub.js");

var _ticket_sub2 = _interopRequireDefault(_ticket_sub);

function _interopRequireDefault(obj) {
    return obj && obj.__esModule ? obj : { default: obj };
}

var user = user_context;
var currentTicket = null;

var createsub = new _ticket_sub2.default(user.unique_id, "create"),
    updatesub = new _ticket_sub2.default(user.unique_id, "update"),
    deletesub = new _ticket_sub2.default(user.unique_id, "delete");
