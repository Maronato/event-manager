...
var _self_subscriptions = require("project/js/self_subscriptions");

var _self_subscriptions2 = _interopRequireDefault(_self_subscriptions);
...
var sub = new _vue2.default({
    ...
    data: function data() {
        return {
            ...
            sub: _self_subscriptions2.default
        };
    },
...
},{"project/js/self_subscriptions":8,"vue":6}],8:[function(require,module,exports){
"use strict";
...
var selfsub = new _subscription.SelfSubscription("update", false);
selfsub.connect();
