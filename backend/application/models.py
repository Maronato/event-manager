...
CV_TYPES = (("LI", "LinkedIn"), ("GH", "GitHub"), ("WS", "Website"), ("OT", "Outro"))
EXPERIENCE_LEVELS = (
    ("basic", "Básico"),
...
class Application(models.Model):
    ...
    age = models.IntegerField(
        validators=[MinValueValidator(5, "A idade mínima é 5 anos.")]
    )
    cpf = models.CharField(
        max_length=20, validators=[CPFValidator(0, "CPF inválido")], default=""
    )
    # School
    ...
    enroll_year = models.IntegerField(
        validators=[
            MinValueValidator(1900, "Hmm, como?"),
            MaxValueValidator(timezone.now().year + 1, "Hmm, como?"),
        ],
        null=True,
        blank=False,
    )
    ...
    country = models.CharField(
        max_length=200, blank=True, null=True, choices=COUNTRY_CHOICES
    )
    ...
    english_level = models.CharField(
        max_length=20, blank=True, null=True, choices=EXPERIENCE_LEVELS
    )
