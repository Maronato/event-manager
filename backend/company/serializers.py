...
class ScanSerializer(PrefetchMixin, serializers.ModelSerializer):
...
class ReadEmployeeSerializer(PrefetchMixin, serializers.ModelSerializer):
...
class EmployeeSubscriptionSerializer(
    SingleInstancePrefetchMixin, ReadEmployeeSerializer
):
    """Allow single instance prefetching"""


class CreateEmployeeSerializer(PrefetchMixin, serializers.ModelSerializer):
    unique_id = serializers.CharField(source="profile.unique_id")
