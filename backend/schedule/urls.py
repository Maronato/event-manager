...
base_router.register(
    "events/registered", api.RegisteredEventViewset, "registered_event"
)
base_router.register(
...
base_router.register(
    "events/checkinable", api.CheckinableEventViewset, "checkinable_events"
)
...
base_router.register(
    "events/checkin/fetch", api.FetchCheckinAttendee, "event_checkin_fetch"
)
