    ...
    def get_context_data(self, **kwargs):
        ...
        schedule_context = {
            "api": {
                ...
                "my_update_event": reverse("schedule:api:my_event-detail", args=[0])[
                    :-2
                ],
                "my_delete_event": reverse("schedule:api:my_event-detail", args=[0])[
                    :-2
                ],
                "registered_list_events": reverse("schedule:api:registered_event-list"),
                "not_registered_list_events": reverse(
                    "schedule:api:not_registered_event-list"
                ),
