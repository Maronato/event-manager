...
# Set to False when developing locally
HEROKU_ENV = eval(os.environ.get('HEROKU_ENV', 'True').capitalize())
...
COMPRESS_LOCAL_NPM_INSTALL = not HEROKU_ENV

if HEROKU_ENV:
    COMPRESS_NODE_MODULES = '$(pwd)/.heroku/vendor/node/lib/node_modules'
